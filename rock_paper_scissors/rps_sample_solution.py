...
class Game():
    ...
    def __init__(self, num_rounds):
        ...
        self.human_player = HumanPlayer()       # Can create objects from another class as attributes of this class
...
class HumanPlayer(Player):     # Inherits attributes from Player()
    def choose(self):
        while True:
...
class ComputerPlayer(Player):      # Inherits attributes from Player()
    def choose(self):
        return choice(['r', 'p', 's'])
